...
const Cashflash = () => {
    ...
    return (
        <div className="flex flex-col w-full max-w-sm items-center justify-center p-4">
            <Link to="/investment-calculator" className="btn w-full mt-4 flex items-center justify-center relative">
            ...
            <Link to="/budget-tracker" className="btn w-full mt-4 flex items-center justify-center relative">
                <div className="absolute left-8">
            ...
            <Link to="/investment-tracker" className="btn w-full mt-4 flex items-center justify-center relative">
                <div className="absolute left-8">
